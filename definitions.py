...
import random
from PyDAQmx import *
from PyDAQmx import Task as PyDAQTask
...
class MultiChannelAnalogInput(): #PyDAQmx Deprecrated
...
class ContinuousMultiChannelAnalogInputInprog(): #PyDAQmx Deprecated
    """Class to create a multi-channel analog input
